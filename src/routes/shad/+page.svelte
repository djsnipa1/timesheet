        ...
        <Tabs.Root value="week">
          <div class="flex items-center">
            ...
            <div class="flex items-center gap-2 ml-auto">
              ...
              <Button size="sm" variant="outline" class="gap-1 text-sm h-7">
        ...
        <Card.Root class="overflow-hidden">
          <Card.Header class="flex flex-row items-start bg-muted/50">
            <div class="grid gap-0.5">
              <Card.Title class="flex items-center gap-2 text-lg group">
                Order Oe31b70H
                <Button
                  size="icon"
                  variant="outline"
          ...
          <Card.Footer class="flex flex-row items-center px-6 py-3 border-t bg-muted/50">
            <div class="text-xs text-muted-foreground">
              Updated <time dateTime="2023-11-23">November 23, 2023</time>
            </div>
            <Pagination.Root count={10} class="w-auto ml-auto mr-0">
              <Pagination.Content>
                <Pagination.Item>
                  <Button size="icon" variant="outline" class="w-6 h-6">
